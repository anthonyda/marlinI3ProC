...
#define MSG_PREHEAT_1                       _UxGT("EsilÃ¤mmitÃ¤ PLA")
#define MSG_PREHEAT_1_N                     _UxGT("EsilÃ¤mmitÃ¤ PLA ")
#define MSG_PREHEAT_1_ALL                   _UxGT("EsilÃ¤. PLA Kaikki")
#define MSG_PREHEAT_1_BEDONLY               _UxGT("EsilÃ¤. PLA Alusta")
#define MSG_PREHEAT_1_SETTINGS              _UxGT("EsilÃ¤mm. PLA konf")
#define MSG_PREHEAT_2                       _UxGT("EsilÃ¤mmitÃ¤ ABS")
#define MSG_PREHEAT_2_N                     _UxGT("EsilÃ¤mmitÃ¤ ABS ")
#define MSG_PREHEAT_2_ALL                   _UxGT("EsilÃ¤. ABS Kaikki")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("EsilÃ¤. ABS Alusta")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("EsilÃ¤mm. ABS konf")
#define MSG_COOLDOWN                        _UxGT("JÃ¤Ã¤hdytÃ¤")
#define MSG_SWITCH_PS_ON                    _UxGT("Virta pÃ¤Ã¤lle")
#define MSG_SWITCH_PS_OFF                   _UxGT("Virta pois")
#define MSG_EXTRUDE                         _UxGT("Pursota")
#define MSG_RETRACT                         _UxGT("VedÃ¤ takaisin")
...
#define MSG_TEMPERATURE                     _UxGT("LÃ¤mpÃ¶tila")
#define MSG_MOTION                          _UxGT("Liike")
#define MSG_FILAMENT                        _UxGT("Filament")
#define MSG_VOLUMETRIC_ENABLED              _UxGT("E in mmÂ³")
...
#define MSG_REFRESH                         _UxGT("PÃ¤ivitÃ¤")
#define MSG_WATCH                           _UxGT("Seuraa")
#define MSG_PREPARE                         _UxGT("Valmistele")
#define MSG_TUNE                            _UxGT("SÃ¤Ã¤dÃ¤")
#define MSG_PAUSE_PRINT                     _UxGT("KeskeytÃ¤ tulostus")
#define MSG_RESUME_PRINT                    _UxGT("Jatka tulostusta")
#define MSG_STOP_PRINT                      _UxGT("PysÃ¤ytÃ¤ tulostus")
...
#define MSG_CONTROL_RETRACT                 _UxGT("VedÃ¤ mm")
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Va. VedÃ¤ mm")
#define MSG_CONTROL_RETRACTF                _UxGT("VedÃ¤ V")
