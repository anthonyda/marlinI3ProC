...
#define MSG_MAIN                            _UxGT("MenÃº principal")
...
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("SegÃ¼ent punt")
...
#define MSG_INFO_MIN_TEMP                   _UxGT("Temp. mÃ­nima")
#define MSG_INFO_MAX_TEMP                   _UxGT("Temp. mÃ xima")
#define MSG_INFO_PSU                        _UxGT("Font alimentacio")

#define MSG_DRIVE_STRENGTH                  _UxGT("ForÃ§a motor")
#define MSG_DAC_PERCENT                     _UxGT("Driver %")
#define MSG_DAC_EEPROM_WRITE                _UxGT("DAC EEPROM Write")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Repren impressiÃ³")
