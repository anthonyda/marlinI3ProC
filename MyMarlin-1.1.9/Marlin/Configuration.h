...
#define HOTEND_OFFSET_X {0.0,32} // (in mm) for each extruder, offset of the hotend on the X axis
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP  0.0  // (°C) Default nozzle temperature for the G26 Mesh Validation Tool.
  ...
  #define BACK_PROBE_BED_POSITION 190 // 0 = front of bed
 ...
 */
  ...
  #define PROBE_PT_1_Y 65
  #define PROBE_PT_2_X 100
  #define PROBE_PT_2_Y 120
  #define PROBE_PT_3_X 185
  #define PROBE_PT_3_Y 190 //max is "BACK_PROBE_BED_POSITION"
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MIN_POS), 15 }
