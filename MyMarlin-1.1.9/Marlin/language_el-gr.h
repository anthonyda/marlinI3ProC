...
#define MSG_DISABLE_STEPPERS                _UxGT("Î‘Ï€ÎµÎ½ÎµÏ�Î³Î¿Ï€Î¿Î¯Î·ÏƒÎ· Î²Î·Î¼Î±Ï„Î¹ÏƒÏ„Î®")
#define MSG_AUTO_HOME                       _UxGT("Î‘Ï…Ï„Î¿Î¼. ÎµÏ€Î±Î½Î±Ï†Î¿Ï�Î¬ ÏƒÏ„Î¿ Î±Ï�Ï‡Î¹ÎºÏŒ ÏƒÎ·Î¼ÎµÎ¯Î¿")
...
#define MSG_LEVEL_BED_HOMING                _UxGT("Î•Ï€Î±Î½Î±Ï†Î¿Ï�Î¬ ÏƒÏ„Î¿ Î±Ï�Ï‡Î¹ÎºÏŒ ÏƒÎ·Î¼ÎµÎ¯Î¿ Î§Î¥Î–")
#define MSG_LEVEL_BED_WAITING               _UxGT("ÎšÎ¬Î½Ï„Îµ ÎºÎ»Î¹Îº Î³Î¹Î± Î½Î± Î¾ÎµÎºÎ¹Î½Î®ÏƒÎµÏ„Îµ")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("Î•Ï€ÏŒÎ¼ÎµÎ½Î¿ ÏƒÎ·Î¼ÎµÎ¯Î¿")
#define MSG_LEVEL_BED_DONE                  _UxGT("ÎŸÎ»Î¿ÎºÎ»Î®Ï�Ï‰ÏƒÎ· ÎµÏ€Î¹Ï€ÎµÎ´Î¿Ï€Î¿Î¯Î·ÏƒÎ·Ï‚!")
#define MSG_SET_HOME_OFFSETS                _UxGT("ÎŸÏ�Î¹ÏƒÎ¼ÏŒÏ‚ Î²Î±ÏƒÎ¹ÎºÏŽÎ½ Î¼ÎµÏ„Î±Ï„Î¿Ï€Î¯ÏƒÎµÏ‰Î½")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("Î•Ï†Î±Ï�Î¼ÏŒÏƒÏ„Î·ÎºÎ±Î½ Î¿Î¹ Î¼ÎµÏ„Î±Ï„Î¿Ï€Î¯ÏƒÎµÎ¹Ï‚")
...
#define MSG_PREHEAT_1_BEDONLY               MSG_PREHEAT_1 _UxGT(" ÎºÎ»Î¯Î½Î·")
#define MSG_PREHEAT_1_SETTINGS              MSG_PREHEAT_1 _UxGT(" ÎµÏ€Î¹Î²ÎµÎ²Î±Î¯Ï‰ÏƒÎ·")
...
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2 _UxGT(" ÎµÏ€Î¹Î²ÎµÎ²Î±Î¯Ï‰ÏƒÎ·")
...
#define MSG_BED_LEVELING                    _UxGT("Î•Ï€Î¹Ï€ÎµÎ´Î¿Ï€Î¿Î¯Î·ÏƒÎ· ÎºÎ»Î¯Î½Î·Ï‚")
#define MSG_LEVEL_BED                       _UxGT("Î•Ï€Î¹Ï€ÎµÎ´Î¿Ï€Î¿Î¯Î·ÏƒÎ· ÎºÎ»Î¯Î½Î·Ï‚")
...
#define MSG_MOVE_01MM                       _UxGT("ÎœÎµÏ„Î±ÎºÎ¯Î½Î·ÏƒÎ· 0,1 Î¼Î¼")
#define MSG_MOVE_1MM                        _UxGT("ÎœÎµÏ„Î±ÎºÎ¯Î½Î·ÏƒÎ· 1 Î¼Î¼")
#define MSG_MOVE_10MM                       _UxGT("ÎœÎµÏ„Î±ÎºÎ¯Î½Î·ÏƒÎ· 10 Î¼Î¼")
#define MSG_SPEED                           _UxGT("Î¤Î±Ï‡Ï�Ï„Î·Ï„Î±")
#define MSG_BED_Z                           _UxGT("ÎšÎ»Î¯Î½Î· Z")
...
#define MSG_AUTOTEMP                        _UxGT("Î‘Ï…Ï„Î¿Î¼. Ï�Ï�Î¸Î¼Î¹ÏƒÎ· Î¸ÎµÏ�Î¼Î¿ÎºÏ�Î±ÏƒÎ¯Î±Ï‚")
...
#define MSG_JERK                            _UxGT("VÎ±Î½Ï„Î¯Î´Ï�Î±ÏƒÎ·")
#if IS_KINEMATIC
...
#define MSG_VMAX                            _UxGT("VÎ¼ÎµÎ³ ")
#define MSG_VMIN                            _UxGT("VÎµÎ»Î±Ï‡")
...
#define MSG_RESTORE_FAILSAFE                _UxGT("Î•Ï€Î±Î½Î±Ï†Î¿Ï�Î¬ Î±ÏƒÏ†Î±Î»Î¿Ï�Ï‚ Î±Î½Ï„Î¹Î³Ï�Î¬Ï†Î¿Ï…")
...
#define MSG_DWELL                           _UxGT("Î‘Î½Î±ÏƒÏ„Î¿Î»Î® Î»ÎµÎ¹Ï„Î¿Ï…Ï�Î³Î¯Î±Ï‚â€¦")
#define MSG_USERWAIT                        _UxGT("Î‘Î½Î±Î¼Î¿Î½Î® Î³Î¹Î± Ï‡Ï�Î®ÏƒÏ„Î·â€¦")
#define MSG_PRINT_ABORTED                   _UxGT("Î”Î¹Î±ÎºÏŒÏ€Ï„ÎµÏ„Î±Î¹ Î· ÎµÎºÏ„Ï�Ï€Ï‰ÏƒÎ·")
...
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Î•Î½Î±Î»Î»Î±Î³Î® Î±Î½Î¬ÏƒÏ…Ï�ÏƒÎ·Ï‚ Î¼Î¼")
...
#define MSG_INIT_SDCARD                     _UxGT("Î Ï�Î¿ÎµÏ„Î¿Î¹Î¼Î±ÏƒÎ¯Î± ÎºÎ¬Ï�Ï„Î±Ï‚ SD")
#define MSG_CNG_SDCARD                      _UxGT("Î‘Î»Î»Î±Î³Î® ÎºÎ¬Ï�Ï„Î±Ï‚ SD")
#define MSG_ZPROBE_OUT                      _UxGT("Î”Î¹ÎµÏ�ÎµÏ�Î½Î·ÏƒÎ· Z ÎµÎºÏ„ÏŒÏ‚ ÎºÎ»Î¯Î½Î·Ï‚")
#define MSG_YX_UNHOMED                      _UxGT("Î•Ï€Î±Î½Î±Ï†Î¿Ï�Î¬ Î§/Î¥ Ï€Ï�Î¹Î½ Î±Ï€ÏŒ Î–")
...
#define MSG_ENDSTOP_ABORT                   _UxGT("ÎœÎ±Ï„Î±Î¯Ï‰ÏƒÎ· endstop ")
#define MSG_HEATING_FAILED_LCD              _UxGT("Î‘Î½ÎµÏ€Î¹Ï„Ï…Ï‡Î®Ï‚ Î¸Î­Ï�Î¼Î±Î½ÏƒÎ·")
#define MSG_ERR_REDUNDANT_TEMP              _UxGT("Î›Î¬Î¸Î¿Ï‚: Î Î›Î•ÎŸÎ�Î‘Î–ÎŸÎ¥Î£Î‘ Î˜Î•Î¡ÎœÎŸÎ¤Î—Î¤Î‘")
#define MSG_THERMAL_RUNAWAY                 _UxGT("Î”Î™Î‘Î¦Î¥Î“Î— Î˜Î•Î¡ÎœÎŸÎ¤Î—Î¤Î‘Î£")
#define MSG_ERR_MAXTEMP                     _UxGT("Î›Î¬Î¸Î¿Ï‚: ÎœÎ•Î“Î™Î£Î¤Î— Î˜Î•Î¡ÎœÎŸÎ¤Î—Î¤Î‘")
#define MSG_ERR_MINTEMP                     _UxGT("Î›Î¬Î¸Î¿Ï‚: Î•Î›Î‘Î§Î™Î£Î¤Î— Î˜Î•Î¡ÎœÎŸÎ¤Î—Î¤Î‘")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Î›Î¬Î¸Î¿Ï‚: ÎœÎ•Î“Î™Î£Î¤Î— Î˜Î•Î¡ÎœÎŸÎ¤Î—Î¤Î‘ ÎšÎ›Î™Î�Î—Î£")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Î›Î¬Î¸Î¿Ï‚: Î•Î›Î‘Î§Î™Î£Î¤Î— Î˜Î•Î¡ÎœÎŸÎ¤Î—Î¤Î‘ ÎšÎ›Î™Î�Î—Î£")
#define MSG_HEATING                         _UxGT("Î˜ÎµÏ�Î¼Î±Î¯Î½ÎµÏ„Î±Î¹â€¦")
#define MSG_BED_HEATING                     _UxGT("Î˜Î­Ï�Î¼Î±Î½ÏƒÎ· ÎºÎ»Î¯Î½Î·Ï‚â€¦")
