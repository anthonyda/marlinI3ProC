...
#define MSG_SD_INSERTED                     _UxGT("CartÃ£o inserido")
#define MSG_SD_REMOVED                      _UxGT("CartÃ£o removido")
...
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("PrÃ³ximo Ponto")
#define MSG_LEVEL_BED_DONE                  _UxGT("Fim nivelaÃ§Ã£o!")
#define MSG_Z_FADE_HEIGHT                   _UxGT("Suavizar altura")
#define MSG_SET_HOME_OFFSETS                _UxGT("Compensar origem")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("AlteraÃ§Ã£o feita")
...
#define MSG_BED_LEVELING                    _UxGT("NivelaÃ§Ã£o Mesa")
#define MSG_LEVEL_BED                       _UxGT("Nivelar Mesa")
#define MSG_LEVEL_CORNERS                   _UxGT("Nivelar Cantos")
#define MSG_NEXT_CORNER                     _UxGT("PrÃ³ximo Canto")
#define MSG_EDITING_STOPPED                 _UxGT("Fim da EdiÃ§Ã£o")
...
#define MSG_UBL_BC_INSERT                   _UxGT("CalÃ§ar e calibrar")
#define MSG_UBL_BC_INSERT2                  _UxGT("Medir")
#define MSG_UBL_BC_REMOVE                   _UxGT("Remover e calibrar")

#define MSG_UBL_MOVING_TO_NEXT              _UxGT("Indo para o PrÃ³ximo")
...
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Fim da EdiÃ§Ã£o")
...
#define MSG_UBL_MESH_HEIGHT_AMOUNT          _UxGT("Tamanho da ElevaÃ§Ã£o")
...
#define MSG_UBL_MESH_LEVELING               _UxGT("NivelaÃ§Ã£o da Malha")
#define MSG_UBL_3POINT_MESH_LEVELING        _UxGT("NivelaÃ§Ã£o 3 pontos")
#define MSG_UBL_GRID_MESH_LEVELING          _UxGT("NivelaÃ§Ã£o Grid")
...
#define MSG_UBL_INFO_UBL                    _UxGT("InformaÃ§Ã£o do UBL")
...
#define MSG_UBL_INVALIDATE_CLOSEST          _UxGT("Invalidar prÃ³ximo")
#define MSG_UBL_FINE_TUNE_ALL               _UxGT("Ajuste Fino de Todos")
#define MSG_UBL_FINE_TUNE_CLOSEST           _UxGT("Ajuar Mais PrÃ³ximo")
#define MSG_UBL_STORAGE_MESH_MENU           _UxGT("Armazenamento Malha")
#define MSG_UBL_STORAGE_SLOT                _UxGT("Slot de MemÃ³ria")
...
#define MSG_UBL_Z_OFFSET_STOPPED            _UxGT("CompensaÃ§Ã£o Z parou")
...
#define MSG_LED_PRESETS                     _UxGT("ConfiguraÃ§Ã£o da Luz")
...
#define MSG_SET_LEDS_DEFAULT                _UxGT("Luz PadrÃ£o")
...
#define MSG_VOLUMETRIC_ENABLED              _UxGT("ExtrusÃ£o em mm3")
#define MSG_FILAMENT_DIAM                   _UxGT("DiÃ¢metro Fil.")
#define MSG_ADVANCE_K                       _UxGT("AvanÃ§ar K")
#define MSG_CONTRAST                        _UxGT("Contraste")
#define MSG_STORE_EEPROM                    _UxGT("Salvar ConfiguraÃ§Ã£o")
#define MSG_LOAD_EEPROM                     _UxGT("Ler ConfiguraÃ§Ã£o")
#define MSG_RESTORE_FAILSAFE                _UxGT("Restauro seguro")
#define MSG_INIT_EEPROM                     _UxGT("Iniciar EEPROM")
#define MSG_REFRESH                         LCD_STR_REFRESH _UxGT(" AtualizaÃ§Ã£o")
#define MSG_WATCH                           _UxGT("InformaÃ§Ãµes")
#define MSG_PREPARE                         _UxGT("Preparar")
#define MSG_TUNE                            _UxGT("Ajustar")
#define MSG_PAUSE_PRINT                     _UxGT("Pausar impressÃ£o")
#define MSG_RESUME_PRINT                    _UxGT("Resumir impressÃ£o")
#define MSG_STOP_PRINT                      _UxGT("Parar impressÃ£o")
#define MSG_CARD_MENU                       _UxGT("Imprimir do SD")
#define MSG_NO_CARD                         _UxGT("Sem cartÃ£o SD")
#define MSG_DWELL                           _UxGT("ZzZzZz...")
#define MSG_USERWAIT                        _UxGT("Clique para retomar")
#define MSG_PRINT_ABORTED                   _UxGT("ImpressÃ£o Abortada")
#define MSG_NO_MOVE                         _UxGT("Sem movimento")
#define MSG_KILLED                          _UxGT("PARADA DE EMERGÃŠNCIA")
...
#define MSG_AUTORETRACT                     _UxGT("RetraÃ§Ã£o AutomÃ¡tica")
...
#define MSG_THERMAL_RUNAWAY                 _UxGT("ESCAPE TÃ‰RMICO")
#define MSG_ERR_MAXTEMP                     _UxGT("Erro:Temp MÃ¡xima")
#define MSG_ERR_MINTEMP                     _UxGT("Erro:Temp MÃ­nima")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Erro:Temp Mesa MÃ¡x")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Erro:Temp Mesa MÃ­n")
...
#define MSG_DELTA_SETTINGS                  _UxGT("ConfiguraÃ§Ã£o Delta")
#define MSG_DELTA_AUTO_CALIBRATE            _UxGT("Auto-CalibraÃ§Ã£o")
...
#define MSG_DRIVE_STRENGTH                  _UxGT("ForÃ§a do Motor")
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Continuar ImpressÃ£o")
#define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("Temp. MÃ­nima Ã© ")
#define MSG_FILAMENT_CHANGE_NOZZLE          _UxGT("  Bocal: ")
#define MSG_ERR_HOMING_FAILED               _UxGT("Falha ao ir Ã  origem")
#define MSG_ERR_PROBING_FAILED              _UxGT("Falha ao sondar")
  ...
  #define MSG_FILAMENT_CHANGE_UNLOAD_2      _UxGT("remoÃ§Ã£o de filamento")

  #define MSG_FILAMENT_CHANGE_INSERT_1      _UxGT("Coloque Filamento")
  #define MSG_FILAMENT_CHANGE_INSERT_2      _UxGT("pressione o botÃ£o")
  #define MSG_FILAMENT_CHANGE_INSERT_3      _UxGT("para continuar...")

  #define MSG_FILAMENT_CHANGE_HEAT_1        _UxGT("Pressione o botÃ£o")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1     _UxGT("Esperando extrusÃ£o")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2     _UxGT("de filamento")

  #define MSG_FILAMENT_CHANGE_RESUME_1      _UxGT("Esperando impressÃ£o")
