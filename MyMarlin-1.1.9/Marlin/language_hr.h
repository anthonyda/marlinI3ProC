...
#define MSG_LEVEL_BED_WAITING               _UxGT("Klikni za poÄ�etak")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("SljedeÄ‡a toÄ�ka")
...
#define MSG_SET_ORIGIN                      _UxGT("Postavi ishodiÅ¡te")
...
#define MSG_COOLDOWN                        _UxGT("HlaÄ‘enje")
#define MSG_SWITCH_PS_ON                    _UxGT("UkljuÄ�i napajanje")
#define MSG_SWITCH_PS_OFF                   _UxGT("IskljuÄ�i napajanje")
#define MSG_EXTRUDE                         _UxGT("Extrude")
#define MSG_RETRACT                         _UxGT("Retract")
#define MSG_MOVE_AXIS                       _UxGT("MiÄ�i os")
#define MSG_BED_LEVELING                    _UxGT("Niveliraj bed")
#define MSG_LEVEL_BED                       _UxGT("Niveliraj bed")
#define MSG_MOVE_X                          _UxGT("MiÄ�i X")
#define MSG_MOVE_Y                          _UxGT("MiÄ�i Y")
#define MSG_MOVE_Z                          _UxGT("MiÄ�i Z")
#define MSG_MOVE_E                          _UxGT("Extruder")
#define MSG_MOVE_01MM                       _UxGT("MiÄ�i 0.1mm")
#define MSG_MOVE_1MM                        _UxGT("MiÄ�i 1mm")
#define MSG_MOVE_10MM                       _UxGT("MiÄ�i 10mm")
...
#define MSG_LOAD_EEPROM                     _UxGT("UÄ�itaj memoriju")
#define MSG_RESTORE_FAILSAFE                _UxGT("UÄ�itaj failsafe")
#define MSG_REFRESH                         _UxGT("OsvjeÅ¾i")
...
#define MSG_HEATING_FAILED_LCD              _UxGT("Grijanje neuspjeÅ¡no")
...
#define MSG_DELTA_CALIBRATE_CENTER          _UxGT("Kalibriraj SrediÅ¡te")
...
#define MSG_CASE_LIGHT                      _UxGT("Osvjetljenje")
  ...
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("ZavrÅ¡eni")
  #define MSG_INFO_PRINT_TIME               _UxGT("Ukupno printanja")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("NajduÅ¾i print")
  ...
  #define MSG_INFO_PRINT_LONGEST            _UxGT("NajduÅ¾i")
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Nastavi print")
  ...
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("ÄŒekaj poÄ�etak")
  ...
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("PriÄ�ekaj")
  #define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("filament load")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Wait for print")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("to resume")
#else // LCD_HEIGHT < 4
  // Up to 2 lines allowed
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("PriÄ�ekaj...")
